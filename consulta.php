...
<form method="post" id="botao-pesquisa" action="consulta.php">
 	 <input type="text" name="busca" placeholder="Digite o nome para pesquisa" autofocus="true"/>
...
include_once "conexao.php";
  ...
  $consulta = $conectar->query("SELECT solicitante, data_1, prioridade, previ_exec, bairro, Rua, num_compl, referencia, falar, contato, data_2, providencia, responsavel_1, data_3, resultado_final, responsavel_2, info_complementares, desc_solic FROM solicitacoes WHERE solicitante like '$solicitante%'");
